...
var ias = (function (my) {
    ...
    my.load = function () {
        queue().defer(d3.json, "/ias/v0.5.1/ias-config.json")
            .defer(d3.json, "/ias/v0.5.1/data/world-countries.json")
            .defer(d3.json, "/ias/v0.5.1/data/centroids.json")
            .defer(d3.json, "/ias/v0.5.1/data/ias-networks.json")
            .defer(d3.json, "/ias/v0.5.1/data/ias-cohorts.json")
            .defer(d3.csv, "/ias/v0.5.1/data/hiv-prevalence-rate.csv")
            .await(ready);
    };
